...
class Graph:
    ...
    def __init__(self, vertices, is_directed=False):
        ...
        Examples::
            >>> from AKDSFramework.graph import Graph
            >>> import numpy as np
    ...
    def add_edge_between(self, start, end, weight):
        """
        Adds edge between two points in a graph. If the graph is not directed then one edge b/w start and end and one
        b/w end and start will be added which has the same weight.
        Args:
